            ...
            <div class="wrap">
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="name" class="input_text long low"/></td>
                    </tr>
                <tr>
                    <td>高度（单位:px）</td>
                    <td><input type="text" name="height" class="input_text long low" value="200"/></td>
                </tr>
                    <tr>
                        <td>排序</td>
                        <td><input type="text" name="sort" class="input_text long low" value="50"/></td>
                    </tr>
                ...
                <div class="column_list" id="JsColumn">
                    <div class="column_child "  data-id="1">
    ...
    <script>
        $(function() {
            ...
            $("#JsAddColumn").on('click', function() {
                ...
                column++;
                var html = '<div class="column_child" data-id="' + column + '">';
            ...
            $("#JsColumn").on('click', '.JsDelete', function() {
                ...
                var that = this;
                $(this).parents(".column_child").remove();
                column--;
            ...
            $("#JsSave").on('click', function() {
                ...
                $.each(children, function(i, item){
                    ...
                    var arr = {"width":width, "sort":sort, "content":content}
                    childData.push(arr);
                });

                var data = {'name':name, 'height' : height, 'sort' : sort, 'columns' : childData};
                $.ajax({
                    'type' : 'post',
                    'dataType' : 'json',
                    'data' : data,
                    'url' : '<?php echo $baseUrl; ?>'+'admin/addRowAction',
